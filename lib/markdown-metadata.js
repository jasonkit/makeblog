// Origin: https://raw.githubusercontent.com/matthewbdaly/marked-metadata-with-options/master/index.js
// modified for taking any markdown engine object

var fs = require('fs');

var MarkdownMetaData = function (file, md) {
	...
	var mdFile = fs.existsSync(file) ? fs.readFileSync(file).toString() : file,
		...
		getMarkdownContent = function (data) {
			...
			return content ? md.render(content) : new Error("Can't get the content");
		};
...
module.exports = MarkdownMetaData;
